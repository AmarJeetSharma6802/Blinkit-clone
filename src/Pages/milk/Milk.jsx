...
function Milk() {
  ...
  const pharmacyItems = [
    ...
    {
      id: 5,
      img: "https://cdn.grofers.com/app/images/category/cms_images/icon/584_1680251645977.png",
        ...
        <div className="left-width-pharmacy">
          <div className="box-itmes">
            {pharmacyItems.map((item) => (
              <div
                key={item.id}
                className={`product-items-pharmacy milk  ${
                  activeId === item.id ? "active" : ""
                }`}
                onClick={(e) => handleLinkClick(e, item)}
              >
                <div className="img-pharmacy milk-height">
                  <img src={item.img} alt={item.name} id="itmes-img-pharmacy-milk" />
                </div>
